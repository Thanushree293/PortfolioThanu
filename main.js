...
$(document).ready(function () {
    ...
    var typed = new Typed(".typing",{
        strings: ["Frontend Developer","JAVA Programmer","Web Developer","Adventurist","Good Listener"],
        typeSpeed: 100,
        backSpeed: 60,
        loop: true,
        fadeOut: true,
    ...
    var typed = new Typed(".typing-2",{
        strings: ["Programmer","Quick learner","Explorer"," Good at Leadership","Results Oriented"],
        typeSpeed: 100,
        backSpeed: 60,
        loop: true,
    });
